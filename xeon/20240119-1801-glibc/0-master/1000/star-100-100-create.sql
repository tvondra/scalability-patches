...
insert into dim2 select i, i from generate_series(1,100000) s(i);
create table dim3 (id serial primary key, val int);
insert into dim3 select i, i from generate_series(1,100000) s(i);
create table dim4 (id serial primary key, val int);
insert into dim4 select i, i from generate_series(1,100000) s(i);
create table dim5 (id serial primary key, val int);
insert into dim5 select i, i from generate_series(1,100000) s(i);
create table dim6 (id serial primary key, val int);
insert into dim6 select i, i from generate_series(1,100000) s(i);
create table dim7 (id serial primary key, val int);
insert into dim7 select i, i from generate_series(1,100000) s(i);
create table dim8 (id serial primary key, val int);
insert into dim8 select i, i from generate_series(1,100000) s(i);
create table dim9 (id serial primary key, val int);
insert into dim9 select i, i from generate_series(1,100000) s(i);
create table dim10 (id serial primary key, val int);
insert into dim10 select i, i from generate_series(1,100000) s(i);
create table dim11 (id serial primary key, val int);
insert into dim11 select i, i from generate_series(1,100000) s(i);
create table dim12 (id serial primary key, val int);
insert into dim12 select i, i from generate_series(1,100000) s(i);
create table dim13 (id serial primary key, val int);
insert into dim13 select i, i from generate_series(1,100000) s(i);
create table dim14 (id serial primary key, val int);
insert into dim14 select i, i from generate_series(1,100000) s(i);
create table dim15 (id serial primary key, val int);
insert into dim15 select i, i from generate_series(1,100000) s(i);
create table dim16 (id serial primary key, val int);
insert into dim16 select i, i from generate_series(1,100000) s(i);
create table dim17 (id serial primary key, val int);
insert into dim17 select i, i from generate_series(1,100000) s(i);
create table dim18 (id serial primary key, val int);
insert into dim18 select i, i from generate_series(1,100000) s(i);
create table dim19 (id serial primary key, val int);
insert into dim19 select i, i from generate_series(1,100000) s(i);
create table dim20 (id serial primary key, val int);
insert into dim20 select i, i from generate_series(1,100000) s(i);
create table dim21 (id serial primary key, val int);
insert into dim21 select i, i from generate_series(1,100000) s(i);
create table dim22 (id serial primary key, val int);
insert into dim22 select i, i from generate_series(1,100000) s(i);
create table dim23 (id serial primary key, val int);
insert into dim23 select i, i from generate_series(1,100000) s(i);
create table dim24 (id serial primary key, val int);
insert into dim24 select i, i from generate_series(1,100000) s(i);
create table dim25 (id serial primary key, val int);
insert into dim25 select i, i from generate_series(1,100000) s(i);
create table dim26 (id serial primary key, val int);
insert into dim26 select i, i from generate_series(1,100000) s(i);
create table dim27 (id serial primary key, val int);
insert into dim27 select i, i from generate_series(1,100000) s(i);
create table dim28 (id serial primary key, val int);
insert into dim28 select i, i from generate_series(1,100000) s(i);
create table dim29 (id serial primary key, val int);
insert into dim29 select i, i from generate_series(1,100000) s(i);
create table dim30 (id serial primary key, val int);
insert into dim30 select i, i from generate_series(1,100000) s(i);
create table dim31 (id serial primary key, val int);
insert into dim31 select i, i from generate_series(1,100000) s(i);
create table dim32 (id serial primary key, val int);
insert into dim32 select i, i from generate_series(1,100000) s(i);
create table dim33 (id serial primary key, val int);
insert into dim33 select i, i from generate_series(1,100000) s(i);
create table dim34 (id serial primary key, val int);
insert into dim34 select i, i from generate_series(1,100000) s(i);
create table dim35 (id serial primary key, val int);
insert into dim35 select i, i from generate_series(1,100000) s(i);
create table dim36 (id serial primary key, val int);
insert into dim36 select i, i from generate_series(1,100000) s(i);
create table dim37 (id serial primary key, val int);
insert into dim37 select i, i from generate_series(1,100000) s(i);
create table dim38 (id serial primary key, val int);
insert into dim38 select i, i from generate_series(1,100000) s(i);
create table dim39 (id serial primary key, val int);
insert into dim39 select i, i from generate_series(1,100000) s(i);
create table dim40 (id serial primary key, val int);
insert into dim40 select i, i from generate_series(1,100000) s(i);
create table dim41 (id serial primary key, val int);
insert into dim41 select i, i from generate_series(1,100000) s(i);
create table dim42 (id serial primary key, val int);
insert into dim42 select i, i from generate_series(1,100000) s(i);
create table dim43 (id serial primary key, val int);
insert into dim43 select i, i from generate_series(1,100000) s(i);
create table dim44 (id serial primary key, val int);
insert into dim44 select i, i from generate_series(1,100000) s(i);
create table dim45 (id serial primary key, val int);
insert into dim45 select i, i from generate_series(1,100000) s(i);
create table dim46 (id serial primary key, val int);
insert into dim46 select i, i from generate_series(1,100000) s(i);
create table dim47 (id serial primary key, val int);
insert into dim47 select i, i from generate_series(1,100000) s(i);
create table dim48 (id serial primary key, val int);
insert into dim48 select i, i from generate_series(1,100000) s(i);
create table dim49 (id serial primary key, val int);
insert into dim49 select i, i from generate_series(1,100000) s(i);
create table dim50 (id serial primary key, val int);
insert into dim50 select i, i from generate_series(1,100000) s(i);
create table dim51 (id serial primary key, val int);
insert into dim51 select i, i from generate_series(1,100000) s(i);
create table dim52 (id serial primary key, val int);
insert into dim52 select i, i from generate_series(1,100000) s(i);
create table dim53 (id serial primary key, val int);
insert into dim53 select i, i from generate_series(1,100000) s(i);
create table dim54 (id serial primary key, val int);
insert into dim54 select i, i from generate_series(1,100000) s(i);
create table dim55 (id serial primary key, val int);
insert into dim55 select i, i from generate_series(1,100000) s(i);
create table dim56 (id serial primary key, val int);
insert into dim56 select i, i from generate_series(1,100000) s(i);
create table dim57 (id serial primary key, val int);
insert into dim57 select i, i from generate_series(1,100000) s(i);
create table dim58 (id serial primary key, val int);
insert into dim58 select i, i from generate_series(1,100000) s(i);
create table dim59 (id serial primary key, val int);
insert into dim59 select i, i from generate_series(1,100000) s(i);
create table dim60 (id serial primary key, val int);
insert into dim60 select i, i from generate_series(1,100000) s(i);
create table dim61 (id serial primary key, val int);
insert into dim61 select i, i from generate_series(1,100000) s(i);
create table dim62 (id serial primary key, val int);
insert into dim62 select i, i from generate_series(1,100000) s(i);
create table dim63 (id serial primary key, val int);
insert into dim63 select i, i from generate_series(1,100000) s(i);
create table dim64 (id serial primary key, val int);
insert into dim64 select i, i from generate_series(1,100000) s(i);
create table dim65 (id serial primary key, val int);
insert into dim65 select i, i from generate_series(1,100000) s(i);
create table dim66 (id serial primary key, val int);
insert into dim66 select i, i from generate_series(1,100000) s(i);
create table dim67 (id serial primary key, val int);
insert into dim67 select i, i from generate_series(1,100000) s(i);
create table dim68 (id serial primary key, val int);
insert into dim68 select i, i from generate_series(1,100000) s(i);
create table dim69 (id serial primary key, val int);
insert into dim69 select i, i from generate_series(1,100000) s(i);
create table dim70 (id serial primary key, val int);
insert into dim70 select i, i from generate_series(1,100000) s(i);
create table dim71 (id serial primary key, val int);
insert into dim71 select i, i from generate_series(1,100000) s(i);
create table dim72 (id serial primary key, val int);
insert into dim72 select i, i from generate_series(1,100000) s(i);
create table dim73 (id serial primary key, val int);
insert into dim73 select i, i from generate_series(1,100000) s(i);
create table dim74 (id serial primary key, val int);
insert into dim74 select i, i from generate_series(1,100000) s(i);
create table dim75 (id serial primary key, val int);
insert into dim75 select i, i from generate_series(1,100000) s(i);
create table dim76 (id serial primary key, val int);
insert into dim76 select i, i from generate_series(1,100000) s(i);
create table dim77 (id serial primary key, val int);
insert into dim77 select i, i from generate_series(1,100000) s(i);
create table dim78 (id serial primary key, val int);
insert into dim78 select i, i from generate_series(1,100000) s(i);
create table dim79 (id serial primary key, val int);
insert into dim79 select i, i from generate_series(1,100000) s(i);
create table dim80 (id serial primary key, val int);
insert into dim80 select i, i from generate_series(1,100000) s(i);
create table dim81 (id serial primary key, val int);
insert into dim81 select i, i from generate_series(1,100000) s(i);
create table dim82 (id serial primary key, val int);
insert into dim82 select i, i from generate_series(1,100000) s(i);
create table dim83 (id serial primary key, val int);
insert into dim83 select i, i from generate_series(1,100000) s(i);
create table dim84 (id serial primary key, val int);
insert into dim84 select i, i from generate_series(1,100000) s(i);
create table dim85 (id serial primary key, val int);
insert into dim85 select i, i from generate_series(1,100000) s(i);
create table dim86 (id serial primary key, val int);
insert into dim86 select i, i from generate_series(1,100000) s(i);
create table dim87 (id serial primary key, val int);
insert into dim87 select i, i from generate_series(1,100000) s(i);
create table dim88 (id serial primary key, val int);
insert into dim88 select i, i from generate_series(1,100000) s(i);
create table dim89 (id serial primary key, val int);
insert into dim89 select i, i from generate_series(1,100000) s(i);
create table dim90 (id serial primary key, val int);
insert into dim90 select i, i from generate_series(1,100000) s(i);
create table dim91 (id serial primary key, val int);
insert into dim91 select i, i from generate_series(1,100000) s(i);
create table dim92 (id serial primary key, val int);
insert into dim92 select i, i from generate_series(1,100000) s(i);
create table dim93 (id serial primary key, val int);
insert into dim93 select i, i from generate_series(1,100000) s(i);
create table dim94 (id serial primary key, val int);
insert into dim94 select i, i from generate_series(1,100000) s(i);
create table dim95 (id serial primary key, val int);
insert into dim95 select i, i from generate_series(1,100000) s(i);
create table dim96 (id serial primary key, val int);
insert into dim96 select i, i from generate_series(1,100000) s(i);
create table dim97 (id serial primary key, val int);
insert into dim97 select i, i from generate_series(1,100000) s(i);
create table dim98 (id serial primary key, val int);
insert into dim98 select i, i from generate_series(1,100000) s(i);
create table dim99 (id serial primary key, val int);
insert into dim99 select i, i from generate_series(1,100000) s(i);
create table dim100 (id serial primary key, val int);
insert into dim100 select i, i from generate_series(1,100000) s(i);
